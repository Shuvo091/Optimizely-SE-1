...
class TestTaskManager(unittest.TestCase):
	...
	def test_generate_report(self):
		...
		self.assertEqual(report["completed"], 1) #Changed to 1 from 2. Logically, 1 task will be completed
		self.assertEqual(report["pending"], 2) #Changed to 2 from 1. Logically, 2 tasks will be pending
